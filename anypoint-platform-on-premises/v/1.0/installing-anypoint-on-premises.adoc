...
[TIP]
====
If you are installing onto an Ubuntu host copy/paste the following into your terminal to install docker, docker-compose, and give docker privileges to the base ubuntu user:
...
exit
exit
# Login again and test docker works on your host with
...
Normally rancher-compose CLI is downloaded from the UI so that it matches the version that your server is running.  However, for your convenience we have made the CLI available for download link:https://drive.google.com/a/mulesoft.com/file/d/0B7Zu0XrNc9M4c1pfNGxUVm5IMlE/view?usp=sharing[here].  Copy it to your host machines and then add it to your PATH so that you can call it from the terminal.  Here’s a potential way to do it.

[source]
----
> sudo cp rancher-compose /usr/bin/.
----

The following steps refer to items that are also explained in the link:http://docs.rancher.com/rancher/quick-start-guide/[Rancher Reference Quick Start Guide]..
...
[source]
----
> sudo docker run -d --restart=always -p 9999:8080 rancher/server
----
...
[NOTE]
====
We use our own internal docker registry. To download these images you will need to have the appropriate permissions added to your Anypoint account.  If you do not already have these, for now you can add your Anypoint username to link:https://docs.google.com/a/mulesoft.com/spreadsheets/d/1IH67o7XmNY9PDjySqYo5ie8GIbLVdaygKRs3NvdV35Y/edit?usp=sharing[this spreadsheet] along with the list of permissions that you need (download ARM or download full platform or both).  You will be notified when you have been given access.
====
...
[source]
----
> java -jar agent-setup.jar -A http://$DOCKER_IP_ADDRESS:8080/hybrid/api/v1 -W "wss://$DOCKER_IP_ADDRESS:8443/mule" -C https://$DOCKER_IP_ADDRESS/accounts -H  7cfdfe00-0677-4510-a2e5-bfb3c3c18458---2 DESIRED_MULE_SERVER_NAME
----
...
|===
|Issuer |test.openam
|Public key |
...
|Public key | 
|Audience | anypoint.mulesoft.local
|Bypass Expiration | unchecked
