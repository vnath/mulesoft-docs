...
Give the newly created stack a name (as a suggestion, name it `anypoint-platform`) and load the `docker-compose.yml` and `rancher-compose.yml` files you obtained from the zip (or github repo).  It’s the equivalent of “rancher-compose create” command.
