...
Once you link:/anypoint-fundamentals/v/3.8/design-and-develop[Design and Develop] your integration applications for use with Mule runtime, you are ready to deploy them to a production environment.
...
You can monitor Mule, get email alerts and more.
